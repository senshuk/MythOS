...
/** Coin a name in a tongue — a settlement ('place') or a lineage surname ('person'). */
export function coinWord(lang: Language, rng: Rng, kind: 'place' | 'person'): string {
  const [lo, hi] = kind === 'place' ? lang.place : lang.person;
