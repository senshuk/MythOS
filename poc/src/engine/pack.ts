...
export let ORG_CATEGORY_DEVOTIONAL = FANTASY_PACK.ORG_CATEGORY_DEVOTIONAL;
export let LEGEND_THEMES = FANTASY_PACK.LEGEND_THEMES;
export let LEGEND_MIN_HOLDERS = FANTASY_PACK.LEGEND_MIN_HOLDERS;
export let LEGEND_SATURATION = FANTASY_PACK.LEGEND_SATURATION;
export let LEGEND_ORDER_HOLDERS = FANTASY_PACK.LEGEND_ORDER_HOLDERS;
export let ORDER_HOLDER_SHARE = FANTASY_PACK.ORDER_HOLDER_SHARE;
export let ORDER_FOUNDING_COOLDOWN_YEARS = FANTASY_PACK.ORDER_FOUNDING_COOLDOWN_YEARS;
export let EMULATE_STANDING = FANTASY_PACK.EMULATE_STANDING;
export let orderNameFor = FANTASY_PACK.orderNameFor;
export let BINDING_CONSTRAINTS = FANTASY_PACK.BINDING_CONSTRAINTS;
export let OATH_HONOR_THRESHOLD = FANTASY_PACK.OATH_HONOR_THRESHOLD;
...
export function setPack(p: UniversePack): void {
  ...
  ORG_CATEGORY_DEVOTIONAL = p.ORG_CATEGORY_DEVOTIONAL;
  LEGEND_THEMES = p.LEGEND_THEMES;
  LEGEND_MIN_HOLDERS = p.LEGEND_MIN_HOLDERS;
  LEGEND_SATURATION = p.LEGEND_SATURATION;
  LEGEND_ORDER_HOLDERS = p.LEGEND_ORDER_HOLDERS;
  ORDER_HOLDER_SHARE = p.ORDER_HOLDER_SHARE;
  ORDER_FOUNDING_COOLDOWN_YEARS = p.ORDER_FOUNDING_COOLDOWN_YEARS;
  EMULATE_STANDING = p.EMULATE_STANDING;
  orderNameFor = p.orderNameFor;
  BINDING_CONSTRAINTS = p.BINDING_CONSTRAINTS;
  OATH_HONOR_THRESHOLD = p.OATH_HONOR_THRESHOLD;
